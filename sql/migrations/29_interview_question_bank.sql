-- ============================================================
-- OMELO 29 — Interview question bank (seed)
--
-- Same interview infrastructure, profession-specific workflow. Suggestions
-- resolve most-specific first: profession → category → general
-- (omelo_interview_question_suggestions). Employers can edit every question
-- before sending the invite. Plain, respectful wording: these are read
-- aloud to people of every background.
-- ============================================================
...
-- Category fallbacks for jobs whose profession has no bank yet
